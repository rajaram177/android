...
public class ProductionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String oid =  intent.getStringExtra("order");
        try {
            JSONObject order = new JSONObject(oid);
            URL = getString(R.string.base_url) + getString(R.string.production_url) +"/"+ order.getString("OID");
            toolbar.setTitle("Production : "+order.getString("ONo"));
        ...
        adapter = new ProductionAdapter(this, detail_list, new ProductionAdapter.OnItemClickListener() {
            @Override public void onItemClick(JSONObject day) {
